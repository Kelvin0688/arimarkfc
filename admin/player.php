            ...
            <div class="container">
                <div class="form-container">
                    <div class="form-header">
                        <h2><?php echo isset($_GET['edit']) ? 'Update' : 'Add'; ?> U-17 Player</h2>
                    </div>
                    ...
                    <form action="player.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="weight" name="weight" value="<?php echo isset($player['weight']) ? $player['weight'] : ''; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="height" class="form-label">Height (cm)</label>
                            <input type="number" class="form-control" id="height" name="height" value="<?php echo isset($player['height']) ? $player['height'] : ''; ?>">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="under" class="form-label">Team Category (U-13 | U-15 | U-17)</label>
                            <select class="form-control" id="under" name="under" required>
                                <option value="">Under?</option> 
                                <option value="U-17" <?php echo isset($player['under']) && $player['under'] == 'U-17' ? 'selected' : ''; ?>>U-17</option> 
                            </select>
                        </div>
                        <div class="mb-3">
                        ...
                        <button type="submit" class="btn btn-primary" name="<?php echo isset($player['id']) ? 'update_player' : 'reg_player'; ?>">
