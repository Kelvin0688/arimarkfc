    ...
    <main class="container col-md-12 ml-sm-auto col-lg-12 px-md-4 py-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">View Players</li>
            </ol>
        </nav>
        <h1 class="h2">U-17 Players</h1>
                ...
                <tbody>
                    <?php foreach ($players as $player): ?>
                        <tr>
                            ...
                            <td><?php echo $player['under']; ?></td>
                            <td><?php echo strlen($player['description']) > 20 ? substr($player['description'], 0, 20) . "..." : $player['description']; ?></td>
                            <td><img src="uploads/<?php echo $player['photo']; ?>" alt="Player Photo" width="50" height="50"></td>
                            <td>
                                <a href="player.php?edit_player=<?php echo $player['id']; ?>" class="btn btn-warning btn-sm">Update</a>
                                <a href="view-players.php?delete_player=<?php echo $player['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this player?');">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
