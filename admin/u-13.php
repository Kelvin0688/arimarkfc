...
<?php include 'navbar.php'; ?>
    <main class="container col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
            ...
            <div class="container">
                <div class="form-container">
                    <div class="form-header">
                        <h2><?php echo isset($_GET['edit']) ? 'Update' : 'Add'; ?> U-13 Player</h2>
                    </div>
                    ...
                    <form action="u-15.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="under" name="under" required>
                                ...
                                <option value="U-13" <?php echo isset($player['under']) && $player['under'] == 'U-13' ? 'selected' : ''; ?>>U-13</option> 
                            </select>
                        </div>
                        <div class="mb-3">
                        ...
                        <button type="submit" class="btn btn-primary" name="<?php echo isset($player['id']) ? 'update_u13' : 'reg_u13'; ?>">
