...
<head>
    ...
    <title><?php echo $editing ? 'Edit Event' : 'Add Event'; ?></title>
    ...
    <main class="container col-md-12 ml-sm-auto col-lg-12 px-md-4 py-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><?php echo $editing ? 'Edit Event' : 'Add Event'; ?></li>
            </ol>
        </nav>
        <div id="content"> 
            <div class="container mt-5">
                <h1 class="text-center"><?php echo $editing ? 'Edit Event' : 'Add Event'; ?></h1>
                        ...
                        <div class="form-container">
                            <form method="post" action="server.php" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="10" required><?php echo htmlspecialchars($description); ?></textarea>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <?php if ($editing && $image): ?>
                                        <img src="uploads/<?php echo htmlspecialchars($image); ?>" alt="Event Image" class="img-thumbnail mt-3">
                                    <?php endif; ?>
                                </div>
                                
                                <button type="submit" class="btn btn-primary" name="<?php echo $editing ? 'update_event' : 'reg_event'; ?>">
                                    <?php echo $editing ? 'Update Event' : 'Add Event'; ?>
                                </button>
                            </form>
                        </div>
                    </div>
