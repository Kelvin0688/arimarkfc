...
$query = "SELECT id, name, position, age, nationality, weight, height, strong_foot, under, description, photo FROM players";
...
<head>
    ...
    <title>ARIMARK FC | U-17 PLAYERS</title>
...
<div id="preloader">
    ...
    <div id="content"> 
        ...
        <h1 class="text-center mt-4 mb-2">U-17</h1>
