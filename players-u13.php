...
$query = "SELECT id, name, position, age, nationality, weight, height, strong_foot, under, description, photo FROM u13";
...
<head>
    ...
    <title>ARIMARK FC | U-13 PLAYERS</title>
...
<body style="background-image: url(./public/back.png);">
 ...
 <div id="preloader">
    ...
    <!-- end nav -->
        ...
        <h1 class="text-center mt-4 mb-2">U-13</h1>
